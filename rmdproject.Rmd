...
\
 ...
 \
 ```{r , echo=FALSE,out.width="100%"}
 ggplot(subset(data, !is.na(Life.expectancy)&!is.na(Schooling)),aes(Schooling,Life.expectancy),na.rm=TRUE)+geom_point(color='red')+geom_smooth(method=lm)+ggtitle("Alcohol consumption vs number of years of Schooling ")
